...
class RegisterAnonymous extends StatefulWidget {
  const RegisterAnonymous({super.key});

  @override
  State<RegisterAnonymous> createState() => _RegisterAnonymousState();
}

class _RegisterAnonymousState extends State<RegisterAnonymous> {
